...
const TopBar = ({ onLogout, notifications, searchQuery, setSearchQuery, wardenData }) => {
        ...
        <div className="profile-container" data-aos="fade-down" data-aos-delay="300">
          ...
          >
            ...
            <div className="profile-info">
              <span className="profile-name">{wardenData?.fullName || 'Warden'}</span>
              <span className="profile-role">Warden</span>
            </div>
